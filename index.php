...
<style>
    ...
    header {
        ...
        padding: 1px;
        /* Un peu d'espace au-dessus et en-dessous */
    }
    ...
    nav {
        ...
        height: 100px;
        /* Ajustez la hauteur de votre header */
    }
...
<body>
    ...
    <header>
        <nav style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; background-color: #F0E6D2; width: 100%; box-sizing: border-box; position: fixed;">
            ...
            <!-- Bouton à droite -->
            <button class="cta-button" onclick="window.location.href='useraccount/user_register.php'" style="margin-left: auto; padding: 0.75rem 1.5rem; background-color: #75ad8c; color: black; border: none; border-radius: 4px; font-size: 1rem; cursor: pointer;">Connexion</button>
        </nav>
    ...
    <section id="about" class="about">
        <div class="about-content">
            <div class="text-content">
                <span style="color: #A8D5BA;">
                    <h1>Bienvenue dans votre espace de gestion de bibliothèque moderne !</h1>
                </span>
    ...
    <section id="features" class="features">
        ...
        <div class="features-container">
            <div class="feature-item">
                ...
                <span style="color: #75ad8c;">
                    <h3> Accédez facilement à notre catalogue</h3>
                </span>
            ...
            <div class="feature-item">
                ...
                <span style="color: #75ad8c;">
                    <h3>Suivez les emprunts et les retours</h3>
                </span>
            ...
            <div class="feature-item">
                ...
                <span style="color: #75ad8c;">
                    <h3>Recherche et réservation ultra-rapides !</h3>
                </span>
    ...
    <section id="about" class="about">
        <div class="about-content">
            <div class="text-content">
                <span style="color: #A8D5BA;">
                    <h3>Un accès sécurisé et personnalisé</h3>
                </span>
    ...
    <section id="about" class="about">
        <div class="about-content">
            <div class="text-content">
                <span style="color: #A8D5BA;">
                    <h3>Une bibliothèque à portée de main, où que vous soyez</h3>
                </span>
    ...
    <section id="about" class="about">
        <div class="about-content">
            <div class="text-content">
                <span style="color: #A8D5BA;">
                    <h2>Une solution innovante pour réinventer votre expérience de bibliothèque</h2>
                </span>
